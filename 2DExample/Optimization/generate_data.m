...
ystart = sparse(m,n);           % start value y^0 in SQP method
ustart = sparse(n,numcontrols); % start value u^0 in SQP method
pstart = sparse(m,n);           % start value p^0 in SQP method
