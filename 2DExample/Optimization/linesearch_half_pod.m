function [sk,uk_new,yk_new,pk_new,J_uk_new]= linesearch_half_pod(ykpod,uk,J_uk,s0,dk,y0pod,c,fxyt,au,M,deltat,yqpod,ay,lambda,Mt,ua,ub,Mpod,Kpod,POD,Mpod4)
...
while J_uk <= J_uk_new && J_uk > 0 && counter < countermax   
    ...
    yk_new = stateeqn_pod(deltat, y0pod, c, fxyt, au, uk_new, Mpod , Kpod , POD , M , Mpod4);
...
sk=si;
pk_new=adjointeqn_pod(n,deltat, yk_new, yqpod, c, ay, Mpod, Kpod, POD, Mpod4, M);