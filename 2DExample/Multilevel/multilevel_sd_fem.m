function [y,ui,p,m,x1,x2,au,M,V1,V2,V3,V4,v,yq,Mt,ay,y0,fxyt,K,tri] =multilevel_sd_fem(mmin, n, mode,linesearch_mode, ustart_ml , lambda, c, deltat,TOL1,TOL2,s0)
...
if(mode == 1 || mode==0)
    ...
    [yopt_fem,uiopt_fem,popt_fem] = ls_fem(m,deltat,lambda,c,fxyt,ay,au,ua,ub,ustart_ml,M,K,y0,yq,V1,V2,V3,V4,v,Mt,linesearch_mode,TOL1,TOL2,s0);
