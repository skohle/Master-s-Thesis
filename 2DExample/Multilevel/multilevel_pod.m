function [y,ui,p,m,x1,x2,au,M,V1,V2,V3,V4,v,yq,Mt,ay,y0,fxyt,K,tri] =multilevel_pod(mmin, n, r,r_deim, mode, errormode,cg_mode,linesearch_mode,pod_mode, ustart , t, lambda, c, deltat,T,TOL1,TOL2,s0,usnap,it)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if pod_mode==0 || pod_mode==1
        ...
        mode_d=0; 
        [~,POD] = PODbasis_cg(n,m,r,deltat,c,fxyt,au,usnap,M,K,Mt,y0,0,mode_d);
        ...
        [yopt_pod,uiopt_pod,popt_pod] = bfgs_pod(n,r,m, x1x2,tri,deltat,lambda,c,fxyt,ay,au,ua,ub,ustart,Mpod,Kpod,Mt,M,y0pod,yqpod,POD,linesearch_mode,TOL1,TOL2,s0);
