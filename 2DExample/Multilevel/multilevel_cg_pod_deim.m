function [y,ui,p,m,x1,x2,au,M,V1,V2,V3,V4,v,yq,Mt,ay,y0,fxyt,K,tri] =multilevel_cg_pod_deim(mmin, n, r,r_deim, mode,cg_mode,linesearch_mode,pod_mode, ustart_ml ,  lambda, c, deltat,TOL1,TOL2,s0,usnap)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if pod_mode==0 || pod_mode==2 && mode==2
            ...
            [y,ui,p] = cg_pod_deim(n,r,r_deim, x1x2,tri,deltat,lambda,c,fxyt,ay,au,ua,ub,ustart_ml,Mpod,Kpod,Mt,M,y0pod,yqpod,POD,U,P,linesearch_mode,cg_mode,TOL1,TOL2,s0,reset);
