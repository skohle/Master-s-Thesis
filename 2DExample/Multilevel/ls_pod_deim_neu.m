   ...
   normgradientsqu = gk'*gk;
    ...
    switch linesearch_mode
        case 1
            ...
            [si,uk,ykpod,pkpod,J_uk]= linesearch_half_pod_deim(ykpod,uk,J_uk,sk,dk,y0pod,c,fxyt,au,M,deltat,yqpod,ay,lambda,Mt,ua,ub,Mpod,Kpod,POD,P,U);
        case 2
